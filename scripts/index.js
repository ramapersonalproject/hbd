...
let countDown = new Date(`${config.birthdate} 19:45:00`).getTime();
x = setInterval(function() {
  ...
  if (distance > 0) {
    ...
    function init() {
      ...
      box.addEventListener('click', direct, false);
    ...
    function direct() {
      ...
      setTimeout("location.href = 'firework.html';",3000);
    }
